...
The ID of the model to use (optional). Examples: "gpt-5", "o3", "gpt-5-mini"
...
Built-in tool objects are forwarded as-is through [OpenAITool](OpenAITool.md), so nested structures like `environment.skills` are preserved.
