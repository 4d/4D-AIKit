...
If ($response.isComplete)
    TRACE("Response is ready: "+$response.outputText)
End if
```
...
TRACE("Text: "+$response.outputText)
```
...
Case of
    : ($response.isComplete)
        TRACE("Complete: "+$response.outputText)
...
TRACE("First response: "+$response1.outputText)
...
TRACE("Second response: "+$response2.outputText)
```
