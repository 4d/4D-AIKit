...
apiKey: cs:C1710._Env.me["OPENAI_API_KEY"]\
}; \
ollama: {\
...
apiKey: cs:C1710._Env.me["ANTHROPIC_API_KEY"]\
}\
}\
}

// Create OpenAI client and inject test providers
var $client:=cs:C1710.OpenAI.new()
// Inject test configuration by directly setting _providers attribute
$client._providers._providers:=$config.providers
