...
var $keys : Collection:=$providers.keys()
...
$providers.add("provider1"; {baseURL: "https://api.new.com/v1"; apiKey: "newkey"})
var $p1 : Object:=$providers.get("provider1")
ASSERT:C1129($p1.baseURL="https://api.new.com/v1"; "Provider1 should be updated, not duplicated")
ASSERT:C1129($providers.keys().length=2; "Should still have 2 providers after update")
...
var $resultUnused : Object:=$providers.remove("unusedProvider")
ASSERT:C1129($resultUnused.success=True:C214; "Should be able to remove unused provider")
ASSERT:C1129($providers.get("unusedProvider")=Null:C1517; "Unused provider should be gone")
ASSERT:C1129($providers.keys().length=1; "Should have 1 provider left")
...
var $resultProtected : Object:=$providers.remove("protectedProvider")
...
ASSERT:C1129($providers.get("protectedProvider")#Null:C1517; "Protected provider should still exist")
...
var $resultVector : Object:=$providers.remove("vectorProvider")
...
ASSERT:C1129($providers.get("vectorProvider")#Null:C1517; "Provider should still exist")
...
var $renameResult : Object:=$providers.rename("oldName"; "newName")
ASSERT:C1129($renameResult.success=True:C214; "Rename should succeed")
ASSERT:C1129($providers.get("oldName")=Null:C1517; "Old name should not exist")
ASSERT:C1129($providers.get("newName")#Null:C1517; "New name should exist")
ASSERT:C1129($providers.get("newName").baseURL="https://api.example.com/v1"; "Config should be preserved")
...
var $renameBlocked : Object:=$providers.rename("blockedName"; "newName")
...
ASSERT:C1129($providers.get("blockedName")#Null:C1517; "Original provider should still exist")
ASSERT:C1129($providers.get("newName")=Null:C1517; "New name should not exist")
...
// Perform rename
var $renameVector : Object:=$providers.rename("myProvider"; "renamedProvider")
