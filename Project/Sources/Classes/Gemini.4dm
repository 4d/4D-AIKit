...
// MARK: api resources
property content : cs:C1710.GeminiContentAPI
property embeddings : cs:C1710.GeminiEmbeddingsAPI
property models : cs:C1710.GeminiModelsAPI
property files : cs:C1710.GeminiFilesAPI
...
property _configurable : Collection:=["apiKey"; "baseURL"; "maxRetries"; "timeout"; "httpAgent"; "customHeaders"]
...
Function _fillDefaultParameters()
	...
	If (Length:C16(This:C1470.apiKey)=0)
		...
		This:C1470.apiKey:=cs:C1710._Env.me["GEMINI_API_KEY"] || ""

	End if

	If (Length:C16(This:C1470.baseURL)=0)

		This:C1470.baseURL:=cs:C1710._Env.me["GEMINI_BASE_URL"] || "https://generativelanguage.googleapis.com/v1beta"
...
/*
* Build an instance of Gemini class.
...
Class constructor( ...  : Variant)
	...
	This:C1470.content:=cs:C1710.GeminiContentAPI.new(This:C1470)
	This:C1470.embeddings:=cs:C1710.GeminiEmbeddingsAPI.new(This:C1470)
	This:C1470.models:=cs:C1710.GeminiModelsAPI.new(This:C1470)
	This:C1470.files:=cs:C1710.GeminiFilesAPI.new(This:C1470)
		...
		: (Value type:C1509($parameters[0])=Is text:K8:3)
			...
			Case of
				: ((Count parameters:C259>1) && (Value type:C1509($parameters[1])=Is text:K8:3))
					...
					// if second string parameter, suppose baseURL
...
Function _authHeaders() : Object
	...
	var $headers:={"x-goog-api-key": String:C10(This:C1470.apiKey)}
	return $headers
...
Function _request($httpMethod : Text; $path : Text; $body : Variant; $parameters : cs:C1710.GeminiParameters; $resultType : 4D:C1709.Class) : cs:C1710.GeminiResult
	If ($resultType=Null:C1517)
		$resultType:=cs:C1710.GeminiResult
	End if
	var $result : cs:C1710.GeminiResult:=$resultType.new()
	...
	If ($async)
		...
		If (Asserted:C1132(($processType#Created from execution dialog:K36:14); "Formula callback will never be called asynchronously with user process. Please create a worker or be in form/app context"))
			$options:=cs:C1710._GeminiAsyncOptions.new($options; This:C1470; $parameters; $result)
		Else
...
Function _doHTTPRequest($url : Text; $options : Object; $result : cs:C1710.GeminiResult; $wait : Boolean; $parameters : cs:C1710.GeminiParameters)
	...
	If ($wait)
		...
		_geminiCallbacks($parameters; $result)
...
Function _get($path : Text; $parameters : cs:C1710.GeminiParameters; $resultType : 4D:C1709.Class) : cs:C1710.GeminiResult
	return This:C1470._request("GET"; $path; Null:C1517; $parameters; $resultType)

Function _post($path : Text; $body : Variant; $parameters : cs:C1710.GeminiParameters; $resultType : 4D:C1709.Class) : cs:C1710.GeminiResult
	return This:C1470._request("POST"; $path; $body; $parameters; $resultType)

Function _delete($path : Text; $parameters : cs:C1710.GeminiParameters; $resultType : 4D:C1709.Class) : cs:C1710.GeminiResult
	return This:C1470._request("DELETE"; $path; Null:C1517; $parameters; $resultType)

Function _getApiList($path : Text; $queryParameters : Object; $parameters : cs:C1710.GeminiParameters; $resultType : 4D:C1709.Class) : cs:C1710.GeminiResult
	return This:C1470._request("GET"; $path+This:C1470._encodeQueryParameters($queryParameters); Null:C1517; $parameters; $resultType)

Function _postFiles($path : Text; $body : Object; $files : Object; $parameters : cs:C1710.GeminiParameters; $resultType : 4D:C1709.Class) : cs:C1710.GeminiResult
	...
	If ($parameters=Null:C1517)
		$parameters:=cs:C1710.GeminiParameters.new()
	End if
...
Function _initRetry($options : Object; $parameters : cs:C1710.GeminiParameters)
...
Function _calculateRetryTimeout($options : Object; $result : cs:C1710.GeminiResult) : Integer
	...
	$nbRetries:=($nbRetries>1000) ? 1000 : $nbRetries  // max 1000 to avoid pow failed
...
Function _delayProcessAfterRetry($options : Object; $result : cs:C1710.GeminiResult) : Integer
