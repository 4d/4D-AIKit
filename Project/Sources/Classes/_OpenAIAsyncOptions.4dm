...
Function onTerminate($request : 4D:C1709.HTTPRequest; $event : Object)
	If (Bool:C1537(This:C1470._parameters.stream))
		If (This:C1470._isResponsesStream())
			This:C1470._onResponsesTerminate($request)
		Else 
			This:C1470._onChatTerminate($request)
		End if 
	Else 
...
Function onData($request : 4D:C1709.HTTPRequest; $event : Object)
	...
	If (This:C1470._isResponsesStream())
		This:C1470._onResponsesData($request; $event)
	Else 
		This:C1470._onChatData($request; $event)
	End if 

Function _isResponsesStream : Boolean
	return (OB Instance of:C1731(This:C1470._parameters; cs:C1710.OpenAIResponsesParameters))

Function _onChatTerminate($request : 4D:C1709.HTTPRequest)
...
Function _onResponsesTerminate($request : 4D:C1709.HTTPRequest)
	var $result : Object
	Case of 
...
Function _onChatData($request : 4D:C1709.HTTPRequest; $event : Object)
	// Preserve the original chat-completions SSE handling unchanged.
	...
	For ($lineIndex; 0; $lines.length-1)
		...
		This:C1470._dispatchStreamChunk($chunkResult)
		
		If (($chunkResult._decodingErrors#Null:C1517) && (Position:C15("data: "; $line)<=0))
			This:C1470._onStreamError:=True:C214
			break
		End if 
...
Function _onResponsesData($request : 4D:C1709.HTTPRequest; $event : Object)
	var $textData:=BLOB to text:C555($event.data; UTF8 C string:K22:15)
	...
	For ($lineIndex; 0; $lines.length-1)
		...
		End if 
		If (Length:C16($line)=0)
			If ((Length:C16(This:C1470._sseEvent.data)>0) && (This:C1470._sseEvent.data#"[DONE]"))
...
Function _dispatchStreamChunk($chunkResult : Variant)
