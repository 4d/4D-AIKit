// ID of the model to use (optional, e.g., "gpt-5" or "o3")
property model : Text
...
// Output configuration for plain text or structured JSON: {format: {...}}
...
// Used to cache responses for similar requests (replaces user field when set)
property prompt_cache_key : Text

// Prompt cache retention policy (ex: "24h")
property prompt_cache_retention : Text
...
// Processing tier to use for the request
...
Function body() : Object
	...
	End if
	If (Length:C16(String:C10(This:C1470.prompt_cache_key))>0)
		$body.prompt_cache_key:=This:C1470.prompt_cache_key
	End if
	If (Length:C16(String:C10(This:C1470.prompt_cache_retention))>0)
		$body.prompt_cache_retention:=This:C1470.prompt_cache_retention
	End if
	...
	End if
	If (Length:C16(String:C10(This:C1470.safety_identifier))>0)
